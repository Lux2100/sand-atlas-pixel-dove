...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CKAT0KA1.mjs");
...
var manifest = { "710138151ae96c3136a76fa87c5bb44ad5a20c29910a2f8bc3d94cb975452d15": {
	functionName: "analyzeFace_createServerFn_handler",
	importer: () => import("./analyze-Ca8YRKrG.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-_a-57kHo.mjs").then((n) => n.t),
